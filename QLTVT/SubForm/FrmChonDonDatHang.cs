...
namespace QLTVT.SubForm
{
    public partial class FrmChonDonDatHang : Form
    {
        ...
        /*  Moi don hang thi chi co duy nhat mot phieu nhap */
        private int kiemTraDonHangCoPhieuNhap
            (String maDonHang)
        {
            String cauTruyVan =
                    "DECLARE	@result int " +
        ...
        private void btnCHON_Click(object sender, EventArgs e)
        {
            ...
            //GridControl gc = datHangGridControl;
            /*gán auto*/
            ...
            if( ketQua == 1)
            {
                //((DataRowView)(bdsDonDatHang.Position));
                //DataRowView drv2 = ((DataRowView)bdsDonDatHang[bdsDonDatHang.Position]);
                //gc. .Enabled = false;
